...
NomC::NomC(std::string fname)
{
    ...
    isMasc=true;
    isFem=true;
    string query="select sing,fem,plur,plurFem,isMasc,isFem,isSing,isPlur,canMasc,canFem,canSing,isDenm,fun from nom natural join mot where basicName=\""+basicName+"\" and type=\""+catMot+"\";";
...
NomC::NomC(std::string fname1, std::string fname2, std::string fname3, std::string fname4, bool isMascu, bool isFemi, bool fIsSing,bool fIsPlur, std::fstream* dataF, bool fIsDenm, bool fCanSing, bool fCanMasc, bool fCanFem, string fun)
{
  basicName=fname1;
  ident=fname1;
  catMot="nom";
...
if(isSing)
  ...
  if(it==Dmots->db.end())
  {
        ...
        string query3="insert into nom(nom_id, basicName,sing,fem,plur,plurFem,isMasc,isFem,isSing,isPlur,canMasc,canFem,canSing,isDenm) values("+s_id+",\""+basicName+"\",\""+sing+"\",\""+fem+"\",\""+plur+"\",\""+plurFem+"\","+s_isMasc+","+s_isFem+","+s_isSing+","+s_isPlur+","+s_canMasc+","+s_canFem+","+s_canSing+","+s_isDenm+");";
  ...
  if(isSing)
  {
    if(isMasc)
    {
        if(canFem)
        {
          ...
          int motId=memory->getIntAt(query);
          if(motId<0) //on créé son nom féminin singulier s'il n'existe pas
          {
              new NomC(fname2,fname1,fname3,fname4,isFemi,true,true,fIsPlur, dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
          }
        }
        if(isDenm)
        {
            ...
            {
                new NomC(fname3,fname4,fname1,fname2,true,isFemi,fIsPlur,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
            }
            if(canFem)
            {
               string query="select mot_id from mot where basicName=\""+fname4+"\" and type=\""+catMot+"\";"; 
                ...
                if(motId<0)
                {
                    new NomC(fname4,fname3,fname1,fname2,isFemi,true,fIsPlur,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
                } 
            }
    ...
    if(isFem)
    {
        if(canMasc)
        {
          ...
          {
              new NomC(fname2,fname1,fname3,fname4,true,isMasc,true,fIsSing,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
          }
        }
        if(isDenm)
        {
            ...
            if(motId<0)
            {
                new NomC(fname4,fname3,fname1,fname2,isFem,true,fIsPlur,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
            }
            if(canMasc)
            {
               string query="select mot_id from mot where basicName=\""+fname3+"\" and type=\""+catMot+"\";"; 
                ...
                if(motId<0)
                {
                    new NomC(fname3,fname4,fname1,fname2,true,isMascu,fIsPlur,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
                } 
            }
...
if(isPlur)
  {
    if(isMasc)
    {
        if(canFem)
        {
          ...
          {
              new NomC(fname2,fname1,fname3,fname4,isFemi,true,fIsSing,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
          }
        }
        if(canSing)
        {
            ...
            {
                new NomC(fname3,fname4,fname1,fname2,true,isFemi,true,fIsSing,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
            }
            if(canFem)
            {
                string query="select mot_id from mot where basicName=\""+fname4+"\" and type=\""+catMot+"\";"; 
                ...
                if(motId<0)
                {
                    new NomC(fname4,fname3,fname1,fname2,isFemi,true,true,fIsSing,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
                } 
            }
    ...
    if(isFem)
    {
        if(canMasc)
        {
          ...
          {
              new NomC(fname2,fname1,fname3,fname4,true,isMasc,fIsSing,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
          }
        }
        if(canSing)
        {
            ...
            if(motId<0)
            {
                new NomC(fname4,fname3,fname1,fname2,isMasc,true,true,fIsSing,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
            }
            if(canMasc)
            {
               string query="select mot_id from mot where basicName=\""+fname3+"\" and type=\""+catMot+"\";"; 
                ...
                if(motId<0)
                {
                    new NomC(fname3,fname4,fname1,fname2,true,isMascu,true,fIsSing,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
                } 
            }
