...
Determinant::Determinant( string fname)
{
    basicName=fname;
    ident=fname;
    catMot=Det;
    ...
    isMasc=true;
    isFem=true;
    string query="select sing,fem,plur,plurFem,isMasc,isFem,isSing,isPlur,canMasc,canFem,canSing,isDenm,fun from determinant natural join mot where basicName=\""+basicName+"\" and type=\""+catMot+"\";";
...
Determinant::Determinant(std::string fname1, std::string fname2, std::string fname3, std::string fname4, bool isMascu, bool isFemi, bool fIsSing, bool fIsPlur, fstream* dataF, bool fIsDenm , bool fCanSing , bool fCanMasc, bool fCanFem, string fun )
{
    basicName=fname1;
  ident=fname1;
  catMot=Det;
...
if(isSing)
  ...
  if(it==Dmots->db.end())
  {
      ...
      string query="insert into mot(basicName,type,fun) values(\""+basicName+"\",\""+catMot+"\",\""+fun+"\");";
        ...
        string query3="insert into determinant(det_id, basicName,sing,fem,plur,plurFem,isMasc,isFem,isSing,isPlur,canMasc,canFem,canSing,isDenm) values("+s_id+",\""+basicName+"\",\""+sing+"\",\""+fem+"\",\""+plur+"\",\""+plurFem+"\","+s_isMasc+","+s_isFem+","+s_isSing+","+s_isPlur+","+s_canMasc+","+s_canFem+","+s_canSing+","+s_isDenm+");";
  ...
  if(isSing)
  {
    if(isMasc)
    {
        if(canFem)
        {
          ...
          {
              new Determinant(fname2,fname1,fname3,fname4,isFemi,true,true,fIsPlur,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
          }
        }
        if(isDenm)
        {
            ...
            {
                new Determinant(fname3,fname4,fname1,fname2,true,isFemi,fIsPlur,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
            }
            if(canFem)
            {
               string query="select mot_id from mot where basicName=\""+fname4+"\" and type=\""+catMot+"\";"; 
                ...
                if(motId<0)
                {
                    new Determinant(fname4,fname3,fname1,fname2,isFemi,true,fIsPlur,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
                } 
            }
    ...
    if(isFem)
    {
        if(canMasc)
        {
          ...
          {
              new Determinant(fname2,fname1,fname3,fname4,true,isMasc,true,fIsSing,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
          }
        }
        if(isDenm)
        {
            ...
            if(motId<0)
            {
                new Determinant(fname4,fname3,fname1,fname2,isFem,true,fIsPlur,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
            }
            if(canMasc)
            {
                string query="select mot_id from mot where basicName=\""+fname3+"\" and type=\""+catMot+"\";"; 
                ...
                if(motId<0)
                {
                    new Determinant(fname3,fname4,fname1,fname2,true,isMascu,fIsPlur,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
                } 
            }
...
if(isPlur)
  {
    if(isMasc)
    {
        if(canFem)
        {
          ...
          {
              new Determinant(fname2,fname1,fname3,fname4,isFemi,true,fIsSing,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
          }
        }
        if(canSing)
        {
            ...
            {
                new Determinant(fname3,fname4,fname1,fname2,true,isFemi,true,fIsSing,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
            }
            if(canFem)
            {
               string query="select mot_id from mot where basicName=\""+fname4+"\" and type=\""+catMot+"\";"; 
                ...
                if(motId<0)
                {
                    new Determinant(fname4,fname3,fname1,fname2,isFemi,true,true,fIsSing,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
                } 
            }
    ...
    if(isFem)
    {
        if(canMasc)
        {
          ...
          {
              new Determinant(fname2,fname1,fname3,fname4,true,isMasc,fIsSing,true,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
          }
        }
        if(canSing)
        {
            ...
            if(motId<0)
            {
                new Determinant(fname4,fname3,fname1,fname2,isMasc,true,true,fIsSing,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
            }
            if(canMasc)
            {
               string query="select mot_id from mot where basicName=\""+fname3+"\" and type=\""+catMot+"\";"; 
                ...
                if(motId<0)
                {
                    new Determinant(fname3,fname4,fname1,fname2,true,isMascu,true,fIsSing,dataF,fIsDenm,fCanSing,fCanMasc,fCanFem,fun);
                } 
            }
